...
// Added NC
void  multipleMatrixLookaheadFiltrationDNA2(const int q,  
    const vector<scoreMatrix> &matrices, const doubleArray &bg, const scoreArray &tol)
{
...
vector<matchArray> doScan(const int q, const vector<scoreMatrix> &matrices,
    const charArray &s, 
